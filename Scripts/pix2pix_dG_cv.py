...
parser.add_argument("--kernelsize", type=int, default=4, help="kernelsize of conv filters")
...
# Moha : --------------------------------------
def gen_conv_dilate(batch_input, out_channels):
    # [batch, in_height, in_width, in_channels] => [batch, out_height, out_width, out_channels]
    initializer = tf.random_normal_initializer(0, 0.02)
    dilate_rate=2
...
for cv in range(0,len(CvDirs)): # #################
    ...
    a.mode='train'
    print('############',a.mode)
    a.checkpoint=a.output_dir_all+'/pix2pix_dG_ST/Models_t'+a.task_No+'/'+SetNames[cv]
    ...
    a.output_dir=a.output_dir_all+'/pix2pix_dG_ST/Models_t'+a.task_No+'/'+SetNames[cv]
    main()
    ...
    a.checkpoint=a.output_dir_all+'/pix2pix_dG_ST/Models_t'+a.task_No+'/'+SetNames[cv]
    a.input_dir=write_to_dir
    a.output_dir=a.output_dir_all+'/pix2pix_dG_ST/Results_t'+a.task_No+'/'+SetNames[cv]
    try:
