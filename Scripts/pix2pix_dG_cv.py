...
for cv in range(1,len(CvDirs)+1): # #################
    ...
    a.mode='train'
    print('############',a.mode)
    a.checkpoint=a.output_dir_all+'/pix2pix_dG_ST/Models_t'+a.task_No+'/set_'+str(cv)
    ...
    a.output_dir=a.output_dir_all+'/pix2pix_dG_ST/Models_t'+a.task_No+'/set_'+str(cv)
    main()
    ...
    a.checkpoint=a.output_dir_all+'/pix2pix_dG_ST/Models_t'+a.task_No+'/set_'+str(cv)
    a.input_dir=write_to_dir
    a.output_dir=a.output_dir_all+'/pix2pix_dG_ST/Results_t'+a.task_No+'/set_'+str(cv)
    try:
