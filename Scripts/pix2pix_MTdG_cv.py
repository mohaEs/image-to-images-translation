...
for cv in range(0,len(CvDirs)): # #################
    ...
    a.mode='train'
    print('############',a.mode)
    a.checkpoint=a.output_dir_all+'/pix2pix_dG_MT/Models_MT'+'/'+SetNames[cv]
    tf.reset_default_graph()
    ...
    a.output_dir=a.output_dir_all+'/pix2pix_dG_MT/Models_MT'+'/'+SetNames[cv]
    main()
    ...
    a.checkpoint=a.output_dir_all+'/pix2pix_dG_MT/Models_MT'+'/'+SetNames[cv]
    a.input_dir=write_to_dir
    a.output_dir=a.output_dir_all+'/pix2pix_dG_MT/Results_MT'+'/'+SetNames[cv]
    try:
